...
**In the air.** Sticks opposite ways spin the board, both sticks the same way roll it over: a full roll landed flat is a Flip, with a spin on top a Rodeo, and a half roll is a face full of water. A tuck (both down) speeds both up.
