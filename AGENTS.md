...
# In the game: T during a solo ride opens the live tuning panel (src/ui/tuningPanel.ts) — nudge stance/rider/recogniser/camera
# constants in place and copy the changed ones as JSON for data/tuning.json.
